-- 0032_planit_summary.sql
-- The PlanIt approval-rate dataset (planit_rates, LAD polygons with
-- approval_pct props) joins the areas reported by point_summary and
-- polygon_summary, so the spot summary and the portfolio scorer see the
-- authority's decision culture. Function bodies otherwise identical to 0030.
    ...
    'areas', (
      ...
      from (
        ...
        where dataset in ('alc','water_availability','gsp_boundary','lad_boundary',
                          ...
                          'la_rents','ptal','hdt','planit_rates')
    ...
    'areas', (
      ...
      from (
        ...
        where dataset in ('alc','water_availability','gsp_boundary','lad_boundary',
                          ...
                          'grey_belt_candidate','planit_rates')
